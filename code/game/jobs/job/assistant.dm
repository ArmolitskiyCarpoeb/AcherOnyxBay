/datum/job/assistant
	title = "Workman"
	description = "Неважно кто ты, бывший заключённый, сбежавший от семьи или доходяга с долгами - это всё в прошлом. Ты тут, что бы выполнять грязную работу. Копай руду, выращивай овощи или готовь пайки. Твоя смена кончается только в двух случаях: когда закончится вахта или когда ты умрёшь."
	department = "Civilian"
	department_flag = CIV
