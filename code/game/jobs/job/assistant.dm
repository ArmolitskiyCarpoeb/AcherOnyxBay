/datum/job/assistant
	title = "Nobody"
	description = "Ты - человек без работы, денег и будущего. Тебя здесь не очень любят! Отыгрыш: Ты буквально никто и кто угодно. Безумец давно застрявший на станции, сбежавший арестант, наркоман в поисках дозы или просто бомж нашедший тут пристанище. Удачи выжить."
	department = "Civilian"
	department_flag = CIV
