/datum/job/assistant
	title = "Assistant"
	description = "Не забывай - твоя помощь ОЧЕНЬ всем нужна, почаще задавай глупые вопросы и кричи: ''СВОБОДНЫЙ АССИСТЕНТ!'' Твои обязанности: уборка, таскание всякого и помощь всем нуждающимся."
	department = "Civilian"
	department_flag = CIV
