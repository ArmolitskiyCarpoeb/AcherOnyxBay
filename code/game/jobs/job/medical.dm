...
/datum/job/doctor
	...
	description = "Купил ли ты лицензию или действительно хорошо учился - неважно. Самое главное - не отрезать случайно голову во время операции. Ты также можешь брать оплату за оказание своих услуг."
	department = "Medical"
	department_flag = MED
