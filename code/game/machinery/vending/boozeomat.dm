...
/obj/machinery/vending/boozeomat
	...
	prices = list(
		/obj/item/reagent_containers/vessel/bottle/gin = 150,
		/obj/item/reagent_containers/vessel/bottle/whiskey = 200,
		/obj/item/reagent_containers/vessel/bottle/specialwhiskey = 150,
		/obj/item/reagent_containers/vessel/bottle/tequilla = 150,
		/obj/item/reagent_containers/vessel/bottle/vodka = 100,
		/obj/item/reagent_containers/vessel/bottle/chacha = 150,
		/obj/item/reagent_containers/vessel/bottle/vermouth = 150,
		/obj/item/reagent_containers/vessel/bottle/rum = 200,
		/obj/item/reagent_containers/vessel/bottle/cognac = 200,
		/obj/item/reagent_containers/vessel/bottle/kahlua = 200,
		/obj/item/reagent_containers/vessel/bottle/melonliquor = 200,
		/obj/item/reagent_containers/vessel/bottle/bluecuracao = 200,
		/obj/item/reagent_containers/vessel/bottle/grenadine = 200,
		/obj/item/reagent_containers/vessel/bottle/herbal = 150,
		/obj/item/reagent_containers/vessel/bottle/absinthe = 150,
		/obj/item/reagent_containers/vessel/bottle/wine = 125,
		/obj/item/reagent_containers/vessel/bottle/winewhite = 175,
		/obj/item/reagent_containers/vessel/bottle/winerose = 175,
		/obj/item/reagent_containers/vessel/bottle/winesparkling = 175,
		/obj/item/reagent_containers/vessel/bottle/small/beer = 100,
		/obj/item/reagent_containers/vessel/bottle/small/ale = 100,
		/obj/item/reagent_containers/vessel/bottle/small/darkbeer = 100,
		/obj/item/reagent_containers/vessel/can/machpellabeer = 100,
		/obj/item/reagent_containers/vessel/can/applecider = 100,
		/obj/item/reagent_containers/vessel/carton/orangejuice = 75,
		/obj/item/reagent_containers/vessel/carton/tomatojuice = 75,
		/obj/item/reagent_containers/vessel/plastic/limejuice = 75,
		/obj/item/reagent_containers/vessel/carton/cream = 75,
		/obj/item/reagent_containers/vessel/bottle/cola = 75,
		/obj/item/reagent_containers/vessel/bottle/space_up = 75,
		/obj/item/reagent_containers/vessel/bottle/space_mountain_wind = 75,
		/obj/item/reagent_containers/vessel/can/sodawater = 75,
		/obj/item/reagent_containers/vessel/can/tonic = 75,
		/obj/item/reagent_containers/vessel/can/cola = 75,
		/obj/item/reagent_containers/vessel/can/colavanilla = 75,
		/obj/item/reagent_containers/vessel/can/colacherry = 75,
		/obj/item/reagent_containers/vessel/tea = 50,
		/obj/item/reagent_containers/vessel/ice = 25
	)
