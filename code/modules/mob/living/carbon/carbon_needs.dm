/mob/living/carbon/proc/print_happiness(mob/living/carbon/human/H)
	var/msg = "\n<div class='firstdiv'><div class='box'>"
	msg += "<span class='info'>I am a follower of </span><font color='red'>[H.client.prefs.religion]</font>.\n"
