...
/mob
	...
	var/list/skills = list("melee" = 0, "ranged" = 0, "medical" = 0, "surgery" = 0, "engineering" = 0, "crafting" = 0, "cooking" = 0, "science" = 0, "gardening" = 0)
...
/mob/proc/generate_skills(var/list/generate_skills)
	...
	for(var/skill in generate_skills)
		skills[skill] = (rand(0,25) + rand(0,30))
		rand_skills -= skill
	for(var/skill in rand_skills)
		//skills[skill] = (rand(1,10) + rand(3,20) + rand(2,15))
		skills[skill] = (rand(1,15) + rand(0,10) + rand(0,10))
...
/mob/proc/add_skills(var/melee_val, var/ranged_val, var/medical_val, var/engineering_val)//To make adding skills quicker.
	if(melee_val)
		skills[SKILL_MELEE] = melee_val
	if(ranged_val)
		skills[SKILL_RANGE] = ranged_val
	if(medical_val)
		skills[SKILL_MED] = medical_val
	if(engineering_val)
		skills[SKILL_ENG] = engineering_val
...
/mob/living/carbon/human/proc/body_build_stats(var/mob/living/carbon/human/H)
	if(istype(H.body_build, /datum/body_build/slim) || istype(H.body_build, /datum/body_build/slim/flat) || istype(H.body_build, /datum/body_build/slim/male) || istype(H.body_build, /datum/body_build/slim/alt))
		...
		adjustDexterity(rand(1,2))
		//H.stats[STAT_DX] -= rand(2,5)
		adjustHealth(rand(-2,-1))
